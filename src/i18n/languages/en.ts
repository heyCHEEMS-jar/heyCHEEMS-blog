...
export const en: Translation = {
	...
	[Key.animeEmptyBilibili]: 'Please check Bilibili configuration or network connection',
	[Key.animeEmptyLocal]: 'Please add anime information in src/data/anime.ts file',
	[Key.animeConfigBilibili]: 'Please set your Bilibili vmid in the src/config.ts file',
	[Key.animeConfigBangumi]: 'Please set your Bangumi userId in the src/config.ts file',
	...
	[Key.rssSubtitle]: 'Subscribe via RSS to get the latest articles and updates immediately',
	...
	[Key.rssBenefit1]: 'Get latest website content in time without manually visiting',
	...
	[Key.atomBenefit1]: 'Get latest website content in time without manually visiting',
