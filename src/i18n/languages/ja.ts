...
export const ja: Translation = {
	...
	[Key.animeEmptyBangumi]: 'Bangumiの構成またはネットワークを接続を確認してください',
	[Key.animeEmptyBilibili]: 'Bilibiliの構成またはネットワーク接続を確認してください',
	[Key.animeEmptyLocal]: 'src/data/anime.tsのファイルにアニメの情報を追加してください',
	[Key.animeConfigBilibili]: 'src/config.tsファイルでBilibili vmidを設定してください',
	[Key.animeConfigBangumi]: 'src/config.tsファイルでBangumi userIdを設定してください',
	...
	[Key.notFoundDescription]: '申し訳ありません、アクセスしたページは存在しないか移動されています。',
	...
	[Key.rssSubtitle]: 'RSSフィードを購読すると最新の記事や更新情報をすぐに確認できます。',
	[Key.rssLink]: 'RSSフィードのリンク',
	[Key.rssCopyToReader]: 'RSSリーダーへのリンクをコピーします',
	[Key.rssCopyLink]: 'コピー',
	[Key.rssLatestPosts]: '最新の投稿',
	[Key.rssWhatIsRSS]: 'RSSとは何ですか?',
	[Key.rssWhatIsRSSDescription]: 'RSS(Really Simple Syndication)は、頻繁に更新されるコンテンツを公開するための標準フォーマットです:',
	[Key.rssBenefit1]: '手動でウェブサイトにアクセスすることなく、最新のコンテンツをタイムリーに入手できます',
	[Key.rssBenefit2]: '複数のウェブサイトへの購読を一括で管理できます',
	[Key.rssBenefit3]: '重要な更新情報や記事を見逃すこともありません',
	[Key.rssBenefit4]: '広告なしのクリーンな読書体験を楽しめます',
	[Key.rssHowToUse]: 'このサイトの購読はFeedly、Inoreaderまたはその他のRSSリーダーの使用をおすすめします。',
	...
	[Key.atomSubtitle]: 'Atomフィードを購読すると最新の記事や更新情報をすぐに確認できます。',
	...
	[Key.atomWhatIsAtomDescription]: 'Atom(Atom Syndication Format)はフィードとその項目を記述するためのXMLベースの標準フォーマットです:',
	[Key.atomBenefit1]: '手動でウェブサイトにアクセスすることなく、最新のコンテンツをタイムリーに入手できます',
	[Key.atomBenefit2]: '複数のウェブサイトへの購読を一括で管理できます',
	[Key.atomBenefit3]: '重要な更新情報や記事を見逃すこともありません',
	[Key.atomBenefit4]: '広告なしのクリーンな読書体験を楽しめます',
	[Key.atomHowToUse]: 'このサイトの購読はFeedly、Inoreaderまたはその他のAtomリーダーの使用をおすすめします。',
	...
	[Key.passwordDecryptError]: '復号に失敗しました。パスワードが正しいかどうか確認してください。',
	...
	[Key.shareOnSocialDescription]: 'この記事が役に立ったときは、ぜひ他の人に共有してください!',
