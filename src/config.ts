...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    src: {
      desktop: [
        '/assets/desktop-banner/傍晚路灯-山脉-水面.webp',
        '/assets/desktop-banner/咖啡店-小白-日落.webp',
        '/assets/desktop-banner/小白-日落-木栈道.webp'
      ],

      mobile: [
        '/assets/mobile-banner/傍晚路灯-山脉-水面.webp',
        '/assets/mobile-banner/咖啡店-小白-日落.webp',
        '/assets/mobile-banner/小白-日落-木栈道.webp'
      ]
    },
...
export const profileConfig: ProfileConfig = {
  ...
  avatar: '/images/albums/Avatar/CHEEMS.jpg',

  name: 'heyCHEEMS',
  bio: '我飞升了自己，却卡在了你的仓库里。\n飞升的意义在于，让别人觉得你在飞升。\n当你看到这句话时，我已经飞升到了下一个commit。\n我在三维写代码，元神在四维review。\n飞升中██████',
...
export const musicPlayerConfig: MusicPlayerConfig = {
  ...
  // Meting API 地址
  meting_api: 'https://meting.elysium-stack.cn/api?server=netease&type=playlist&id=12592904120',
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
  ...
  // 侧栏组件布局配置
  components: {
    left: ['profile', 'announcement', 'umami', 'tags', 'card-toc'],
    right: ['site-stats', 'calendar', 'categories', 'music-sidebar'],
    drawer: ['profile', 'announcement', 'umami', 'music-sidebar', 'categories', 'tags']
  },
...
export const pioConfig: import('./types/config').PioConfig = {
  ...
  models: ['/pio/models/kp31/model.json'],
  ...
  dialog: {
    ...
    touch: ['没事别点我！', '你在干嘛', '去！去！去！', '退！退！退！'],

    // 首页提示
    home: '点击这里去首页！',

    skin: ['要看看我的新装扮吗？', '这身装扮挺好看~'],
