...
export const siteConfig: SiteConfig = {
	...
	banner: {
        ...
        使用本地横幅图片*/
		src: {
			desktop: ['/assets/desktop-banner/1.webp', '/assets/desktop-banner/2.webp', '/assets/desktop-banner/3.webp', '/assets/desktop-banner/4.webp'],

			mobile: ['/assets/mobile-banner/1.webp', '/assets/mobile-banner/2.webp', '/assets/mobile-banner/3.webp', '/assets/mobile-banner/4.webp']
		},
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	// 使用本地横幅图片
	src: {
		desktop: ['/assets/desktop-banner/5.webp', '/assets/desktop-banner/4.webp', '/assets/desktop-banner/3.webp', '/assets/desktop-banner/2.webp', '/assets/desktop-banner/1.webp'],

		mobile: ['/assets/desktop-banner/5.webp', '/assets/desktop-banner/4.webp', '/assets/desktop-banner/3.webp', '/assets/desktop-banner/2.webp', '/assets/desktop-banner/1.webp']
	},
