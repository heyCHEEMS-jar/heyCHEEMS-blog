...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    homeText: {
      ...
      subtitle: ['欢迎来到CHEEMS的小窝~', '没事就爱整点没用的~', '在找AE大芬工程？那你找对地方了'],
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
  ...
  src: {
    desktop: [
      '/assets/desktop-banner/CHEEMS_Cap.png',
      '/assets/desktop-banner/CHEEMS_Christmas.jpg'
    ],

    mobile: [
      '/assets/mobile-banner/CHEEMS.jpg',
      '/assets/mobile-banner/CHEEMS_Cap.png',
      '/assets/mobile-banner/CHEEMS_Christmas.jpg'
    ]
  },
