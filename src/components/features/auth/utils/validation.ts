...
export function showError(errorMessage: HTMLElement | null, message: string): void {
	if (errorMessage) {
...
export function setInputEnabled(input: HTMLInputElement | null, enabled: boolean): void {
	if (input) {
		input.disabled = !enabled
	}
}

export function setButtonEnabled(button: HTMLButtonElement | null, enabled: boolean, text?: string): void {
	if (button) {
