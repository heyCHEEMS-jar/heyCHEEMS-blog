...
export function togglePlay(state: AudioPlayerState, audio: HTMLAudioElement | undefined) {
...
export function handleLoadSuccess(state: AudioPlayerState, audio: HTMLAudioElement | undefined) {
...
export function handleUserInteraction(state: AudioPlayerState, audio: HTMLAudioElement | undefined) {
