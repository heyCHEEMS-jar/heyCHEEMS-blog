...
export const devicesData: DeviceCategory = {
  PC: [{
    ...
    description: '后来把GTX 970换成了GTX 1660 Ti，R5 5600X的CPU性能刚好让GTX 1660 Ti满载不浪费，6G显存刚好够1080P不爆显存，整机不到300W的功耗落在500W电源的最佳效率区间。没有瓶颈，没有冗余，每分钱和每瓦电都花在了刀刃上。'
  }, {
    name: '台式主机 3',
    ...
    description: '高中时装的第三台机子，前两台没少折腾，这台已经把钱花在了极致的刀刃上。R5 5600配6650 XT，1080P下基本没有跑不动的游戏。120水冷纯属图个好看，毕竟这U百元风冷就能压住。550W电源带这套300W出头的整机绰绰有余，1TB固态随便用。虚幻4跑着色器编译和烘培光照也能扛得住，但16G内存有点不够，有时给我整个引擎干崩，也算高中阶段用过的综合实力较强的一台机子了。'
  }, {
    name: '台式主机 1',
  ...
  服务器: [{
    ...
    description: '这套跑个人博客和网站，性能严重过剩。R7 7700的8核Zen4单核性能碾压各种轻量应用服务器。内存涨的堪比金条，就用一根16G DDR5 5600绰绰有余，跑个几十个容器不在话下。500G固态做系统盘+数据库完全够用，SG13B小机箱放家里不占地方，整机满载不到150W，电费几乎可以忽略。'
  }],
  ...
  主机: [{
    ...
    description: '当初用这台跑地平线5，4 TFLOPS的RDNA2在4K电视上虽然会糊，但在1080P/1440P显示器上开性能模式还是可以稳60帧的，毕竟不到两千块的机器还能说啥呢。Quick Resume切换极快，开了XGP单机随便试错也不心疼。但微软独占确实少得可怜，想玩别的还得跟PS5共享第三方。加上512G硬盘装个地平线5再加两三个单机就满了，删游戏得精打细算。'
  }],
  ...
  Laptop: [{
    ...
    description: '同价位最能打的轻薄游戏本，i7-14650HX 8大核+8小核，13代桌面下放魔改，单核多核都够猛，140W满血RTX 4060配合2.5K屏，DLSS3加持下可以畅玩几乎所有游戏。重点是1.9kg、19.9mm机身里塞进了这套配置，便携性完胜同级产品。短板是机革的售后网点不如御三家，而且高负载下风噪较大。'
  }, {
    name: '戴尔游匣G15 5520',
    ...
    description: '这配置是2022年水桶机代表。i7-12700H采用大小核架构 6大核+8小核，多核性能碾压同代锐龙，配合140W满血RTX 3060，1080P下几乎通吃所有3A。短板是戴尔祖传的单硬盘位，以及没有直连切换开关，需外接显示器才能绕开核显。'
  }],
