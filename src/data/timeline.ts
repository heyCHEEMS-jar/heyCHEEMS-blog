...
export const timelineData: TimelineItem[] = [
	{
		...
		achievements: ['Current GPA: 3.6/4.0', 'Completed data structures and algorithms course project', 'Participated in multiple course project developments'],
	...
	},
	{
		...
		achievements: ['Mastered modern frontend development tech stack', 'Learned responsive design and user experience optimization', 'Completed the full process from design to deployment'],
		links: [
			{
	...
	},
	{
		...
		achievements: ['Completed user interface component development', 'Learned team collaboration and code standards', 'Received outstanding internship performance certificate'],
	...
	},
	{
		...
		achievements: ['Received course completion certificate', 'Completed 5 practical projects', 'Mastered full-stack development fundamentals'],
		links: [
			{
	...
	},
	{
		...
		achievements: ['Received excellent course project grade', 'Implemented complete CRUD functionality', 'Learned database design and optimization'],
	...
	},
	{
		...
		achievements: ['Won third prize in university contest', 'Improved algorithmic thinking ability', 'Strengthened programming fundamentals'],
	...
	},
	{
		...
		achievements: ['Helped 3 students master Python basics', 'Improved expression and communication skills', 'Gained teaching experience'],
		icon: 'material-symbols:school',
		color: '#059669'
	},
	{
		...
		achievements: ['College entrance exam score: 620', 'Received municipal model student award', 'Won provincial second prize in math competition'],
		icon: 'material-symbols:school',
		color: '#2563EB'
	},
	{
		...
		achievements: ['Completed first "Hello World" program', 'Learned basic loops and conditional statements', 'Developed interest in programming'],
		icon: 'material-symbols:code',
		color: '#7C3AED'
	}
]
