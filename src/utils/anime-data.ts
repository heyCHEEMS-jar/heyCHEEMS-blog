...
export function getAnimeList(mode: string, sourceConfigs: Record<string, AnimeSourceConfig>): { animeList: AnimeItem[]; currentConfig: AnimeSourceConfig | undefined } {
...
export function getStatusMap(): Record<string, { text: string; class: string; icon: string }> {
	return {
		watching: {
