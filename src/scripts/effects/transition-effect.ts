...
export class TransitionEffect {
	 ...
	 */
	applyConfig(): void {
		const { duration, easing, easingOut, translateDistance, staggerDelay } = this.config
...
export function getTransitionEffect(config?: Partial<TransitionConfig>): TransitionEffect {
