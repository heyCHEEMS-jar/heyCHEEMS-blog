...
const targets = ['assets/home/*.png', 'assets/home/*.jpg', 'sakura.png', 'images/albums/**/*.jpg', 'images/albums/**/*.jpeg', 'images/diary/*.jpg', 'images/device/*.png', 'assets/music/cover/*.jpg']
...
async function convertToWebP(inputPath, quality = 85) {
	...
	try {
		...
		console.log(`   ${(inputSize / 1024).toFixed(1)}KB → ${(outputSize / 1024).toFixed(1)}KB (${savings}% saved)`)
	} catch (err) {
