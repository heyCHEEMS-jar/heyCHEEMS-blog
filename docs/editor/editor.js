...
;(function () {
	...
	const CODE_TRANSLATIONS = {
		'zh-TW': {
			...
			总结: '總結',
			加密内容: '加密內容',
			'这是一篇加密文章，只有输入正确密码才能查看': '這是一篇加密文章，只有輸入正確密碼才能查看',
			敏感信息: '敏感資訊',
		...
		en: {
			...
			'这是一篇加密文章，只有输入正确密码才能查看': 'This is an encrypted article. Enter the correct password to view.',
			敏感信息: 'Sensitive Info',
		...
		ja: {
			...
			まとめ: 'まとめ',
			暗号化コンテンツ: '暗号化コンテンツ',
			'この記事は暗号化されています。正しいパスワードを入力してください。': 'この記事は暗号化されています。正しいパスワードを入力してください。',
			機密情報: '機密情報',
	...
	function setTheme(theme) {
		...
		if (hljsStyleLink) {
			hljsStyleLink.href = theme === 'light' ? 'https://cdn.jsdelivr.net/npm/highlight.js@11/styles/github.min.css' : 'https://cdn.jsdelivr.net/npm/highlight.js@11/styles/github-dark.min.css'
		}
